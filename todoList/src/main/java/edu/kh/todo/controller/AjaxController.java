 ...
 * 
 * (참고)
 * Sping에서 HttpMessageConvertor가 동작하기 위해서는
...
public class AjaxController {
	...
	public int addTodo( // @RequestParam는 일반적으로 쿼리 파라미터나 URL 파라미터에 사용
			...
			@RequestBody Todo todo // 요청 body에 답긴 값을 Todo DTO에 저장
		...
		// Todo(todoNo=0, todoTitle=춥다, todoContent=춥다잉, complete=null, regDate=null)
	...
	@ResponseBody
	@PutMapping("update")
	public int updateSubmit(@RequestBody Todo todo) {
		return service.ajaxUpdate(todo);
	}
