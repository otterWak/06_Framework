...
public class TodoController {
	...
	@GetMapping("detail")		// /todo/datil GET 방식 요청 매핑
	...
	// http://localhost/todo/changeComplete?todoNo=5&complete=Y
	/** 완료 여부 변경
	...
	public String todoUpdate(@RequestParam("todoNo") int todoNo, Model model) {
		Todo todo = service.todoUpdate(todoNo);
	...
	public String updateSubmit(
		...
		int result = service.updateSubmit(todoNo, todoTitle, todoContent);
