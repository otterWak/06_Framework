...
public class ParameterController {
	...
	public String paramTest3(
		...
		// {color=Red, fruit=Apple, productName=아름다운조명, expirationDate=2024-10-31}
	...
	public String paramTest4(/*@ModelAttribute*/ MemberDTO inputMember) {
		...
		// inputMember : MemberDTO(memberId=user01, memberPw=pass01, memberName=유저일, memberAge=20)
